...
export class Auto1733991389755 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "Answer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "text" text NOT NULL, "rating" integer NOT NULL DEFAULT '0', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "authorId" uuid, "questionId" uuid, CONSTRAINT "PK_4d437db1a849fc5c36e25c55daf" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "RefreshToken" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" text NOT NULL, "userId" uuid, CONSTRAINT "PK_b575dd3c21fb0831013c909e7fe" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
      `CREATE TABLE "Role" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "role" "public"."Role_role_enum" NOT NULL DEFAULT 'user', CONSTRAINT "UQ_7e5fbe13db7686818270d8e46fa" UNIQUE ("role"), CONSTRAINT "PK_9309532197a7397548e341e5536" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "Question" ADD CONSTRAINT "FK_0858514c1be529c479f9af2539e" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "Answer" ADD CONSTRAINT "FK_c5eadd1abbce85ac60e0f439211" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "Answer" ADD CONSTRAINT "FK_70a070639c8e235f849e8078760" FOREIGN KEY ("questionId") REFERENCES "Question"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "RefreshToken" ADD CONSTRAINT "FK_8e913e288156c133999341156ad" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "RefreshToken" DROP CONSTRAINT "FK_8e913e288156c133999341156ad"`
    );
    await queryRunner.query(
      `ALTER TABLE "Answer" DROP CONSTRAINT "FK_70a070639c8e235f849e8078760"`
    );
    await queryRunner.query(
      `ALTER TABLE "Answer" DROP CONSTRAINT "FK_c5eadd1abbce85ac60e0f439211"`
    );
    await queryRunner.query(
      `ALTER TABLE "Question" DROP CONSTRAINT "FK_0858514c1be529c479f9af2539e"`
    );
    await queryRunner.query(
